...
public class StateView extends LinearLayout {
    ...
    public StateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.StateView, defStyleAttr, R.style.StateViewConfig);
    ...
    private void setLoadingView() {
        ...
        if(mLoadingView==null){
            mLoadingView = mInflater.inflate(R.layout.view_stateview_loading, null);
            LinearLayout loadMore_Ll = (LinearLayout) mLoadingView.findViewById(R.id.stateview_loadMore_Ll);
            ProgressBar loadingBar = (ProgressBar) mLoadingView.findViewById(R.id.stateview_loadingBar);
            ImageView loadingIv = (ImageView) mLoadingView.findViewById(R.id.stateview_loadingIv);
            TextView loadingTv = (TextView) mLoadingView.findViewById(R.id.stateview_loadingTv);
    ...
    private void setEmptyView() {
        if(mEmptyView==null){
            mEmptyView = mInflater.inflate(R.layout.view_stateview_empty, null);
            ImageView emptyImage = (ImageView) mEmptyView.findViewById(R.id.stateview_empty_image);
            TextView emptyText = (TextView) mEmptyView.findViewById(R.id.stateview_empty_text);
    ...
    private void setDisConnectView() {
        if(mDisConnectView==null){
            mDisConnectView = mInflater.inflate(R.layout.view_stateview_disconnect, null);
            ImageView disConnectImage = (ImageView)mDisConnectView.findViewById(R.id.stateview_disconnect_image);
            TextView disConnectText = (TextView) mDisConnectView.findViewById(R.id.stateview_disconnect_text);
