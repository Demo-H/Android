package com.dhunter.common.percentlayout;
...
public class PercentLayoutHelper {
    ...
    private void supportTextSize(int widthHint, int heightHint, View view, PercentLayoutInfo info){
        ...
        if(widthTextSizePercent != -1f){
            ...
            textSize = DisplayUtils.getScreenWidthPixels(view.getContext()) * screenWidthSizePercent;
        }
    ...
    public static class PercentLayoutInfo {
        ...
        public void fillMarginLayoutParams(View view, ViewGroup.MarginLayoutParams params,
            ...
            int screenWidth = DisplayUtils.getScreenWidthPixels(view.getContext());
