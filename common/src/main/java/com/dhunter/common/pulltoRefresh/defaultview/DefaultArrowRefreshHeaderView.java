package com.dhunter.common.pulltoRefresh.defaultview;
...
import com.dhunter.common.pulltoRefresh.PullToRefreshRecyclerViewUtils;
import com.dhunter.common.pulltoRefresh.base.refreshview.BasePullToRefreshView;
...
//	private AVLoadingIndicatorView progressView;
	...
	public void initView(Context context) {
		...
		mRefrehsContainer = (LinearLayout)mContainer.findViewById(R.id.refresh_time_container);
		...
		arrowIv = (ImageView)mContainer.findViewById(R.id.refresh_arrow);
		refreshStateTv = (TextView)mContainer.findViewById(R.id.refresh_status_tv);
//		progressView = mContainer.findViewById(R.id.av_progressbar);
//		progressView.setIndicatorColor(0xffB5B5B5);
		lastRefreshTimeTv = (TextView)mContainer.findViewById(R.id.last_refresh_time);
