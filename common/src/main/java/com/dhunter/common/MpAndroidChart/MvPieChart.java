...
package com.dhunter.common.MpAndroidChart;
...
public class MvPieChart extends PieChart {
    ...
    public MvPieChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MvPieChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setHoleColor(int color) {
        ((MvPieChartRenderer) mRenderer).getPaintHole().setColor(color);
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((MvPieChartRenderer) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((MvPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((MvPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setCenterTextColor(int color) {
        ((MvPieChartRenderer) mRenderer).getPaintCenterText().setColor(color);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((MvPieChartRenderer) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((MvPieChartRenderer) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    public void setEntryLabelColor(int color) {
        ((MvPieChartRenderer) mRenderer).getPaintEntryLabels().setColor(color);
    }
    ...
    public void setEntryLabelTypeface(Typeface tf) {
        ((MvPieChartRenderer) mRenderer).getPaintEntryLabels().setTypeface(tf);
    }
    ...
    public void setEntryLabelTextSize(float size) {
        ((MvPieChartRenderer) mRenderer).getPaintEntryLabels().setTextSize(Utils.convertDpToPixel(size));
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof MvPieChartRenderer) {
            ((MvPieChartRenderer) mRenderer).releaseBitmap();
        }
